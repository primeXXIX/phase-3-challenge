...
function Database(cn, dc, config) {
     ...
     *    - methods `batch`, `page` and `sequence`, same as inside a {@link Task} **(added in v6.4.0)**
     ...
     *
     * You can also use this object to selectively shut down one connection pool, as opposed to all of them, which {@link module:pg-promise~end pgp.end} does.
     *
     * @see
     * {@link Database}
